...
def retrieve_eclipse_cdt_pull_comments():
    repo_url = "https://api.github.com/repos/eclipse-cdt/cdt/issues"
    ...
    if response.status_code == 200:
        ...
        for issue in list_of_issues:
            ...
            url = 'https://api.github.com/repos/eclipse-cdt/cdt/issues/' + str(issue_number) + '/comments'
            ...
            for comment in data:
                ...
                if result == None:
                    ...
                    body = "\n".join(lines)
                    request_id = (comment['issue_url']).replace('https://api.github.com/repos/eclipse-cdt/cdt/issues/', '')
                    ...
                    result = cursor.fetchone()
                    if result == None:
                        cursor.execute('INSERT INTO Comments(CommentID, AuthorID, Body, Timestamp, CommentURL, SentimentScore, Association, StopWordRatio, RequestID) VALUES(?,?,?,?,?,?,?,?,?)', (comment_id, author_id, body, timestamp, comment_url, sentiment_score, association, stop_word_ratio, issue_number))
